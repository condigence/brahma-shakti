...
//            Arrays.asList(
//                    User.builder().id("9742503868").username("condigence").lastName("Aryan").address("S M Nagar").contact("9742503868").email("onlyvishalaaryan@gmail.com").password("$2a$12$VZSBLRb/bR9kOJofU.FQIuIK/r9z.61573K.W6XaERFFqkF2C6oMa").otp("1234").build(),
