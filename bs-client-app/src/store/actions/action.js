...
export const addSubToCart = (product,subscription) => (dispatch) => {
...
export const removeFromSubCart = (product_id) => (dispatch) => {
  toast.success("Item Removed from Cart");
  dispatch({
...
export const editSubProductCartItem = (subscription,product) => (dispatch) => {
  dispatch({
...
export const incrementSubQuantity = (product_id) => (dispatch) => {
  dispatch({
    type: types.INCREMENT_SUB_QUANTITY,
    product_id,
  });
};
...
export const decrementSubQuantity = (product_id) => (dispatch) => {
  dispatch({
    type: types.DECREMENT_SUB_QUANTITY,
    product_id,
  });
};
